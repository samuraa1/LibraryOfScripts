...
local function Maximise()
	Debounce = true
	Topbar.ChangeSize.Image = "rbxassetid://"..10734895530
				...
				if element.ClassName == "Frame" then
					if element.Name ~= "SectionSpacing" and element.Name ~= "Placeholder" then
                        ...
                        elseif element.Name == "Label" then
                            ...
                            TweenService:Create(element, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {BackgroundTransparency = 0.8}):Play()
                            TweenService:Create(element.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {Transparency = 0}):Play()
                            TweenService:Create(element.Icon, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {ImageTransparency = 0.2}):Play()
                            TweenService:Create(element.Title, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {TextTransparency = 0.2}):Play()
						elseif element.Name == 'Divider' then
...
local function Minimise()
	Debounce = true
	Topbar.ChangeSize.Image = "rbxassetid://"..10734886496
...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    Topbar.Title.Font = Enum.Font.GothamBold
    Topbar.Title.TextSize = 20
	...
	local uiCorner = Main:FindFirstChildOfClass("UICorner") or Instance.new("UICorner", Main)
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "Skibidi Hub",
					Content = "Enjoying this Script? Find it at https://discord.gg/dtneYN6NTY",
					Duration = 7,
					Image = 4370033185,
				})
			end
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		local TabButtonCorner = TabButton:FindFirstChildOfClass("UICorner") or Instance.new("UICorner")
        TabButtonCorner.CornerRadius = UDim.new(0, 9)
        ...
        function RayfieldLibrary:CreateChangelogDialog(config)
            local changelogText = type(config) == "string" and config or (type(config) == "table" and config.ChangelogText or "")
            local showSearchBar = type(config) == "table" and config.Search ~= false -- Default to true if unspecified
            local dialogTitle = type(config) == "table" and config.Title or "Skibidi Hub - Changelog" -- Configurable title
            local notificationsEnabled = type(config) == "table" and config.Notifications ~= false -- New: Notification toggle, default to true
            local altButton = type(config) == "table" and config.Altbutton or { Name = "Join Discord", Clipboard = "https://discord.gg/dtneYN6NTY" } -- Default to Join Discord
            local notification = type(config) == "table" and config.Notification or { Title = "Changelog Closed", Content = "The changelog has been closed", Duration = 2.5, Image = 10723346871 } -- Default close notification
            local altButtonNotification = type(config) == "table" and config.AltbuttonNotification or {
                Success = { Title = altButton.Name .. " Copied", Content = "The link has been copied to your clipboard!", Duration = 6.5, Image = 10709798443 },
                Failure = { Title = altButton.Name .. " Failed", Content = "Your executor doesn't support setclipboard.", Duration = 6.5, Image = 10709799124 }
            } -- Default alt button notifications
            ...
            local existingDialog = Rayfield:FindFirstChild("ChangelogDialog")
            ...
            ChangelogDialog.BackgroundColor3 = SelectedTheme.Background or Color3.fromRGB(30, 30, 30)
            ...
            ChangelogDialog.Parent = Rayfield
            ...
            DialogTitle.TextColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
            ...
            if showSearchBar then
                ...
                SearchBar.BackgroundColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
                ...
                SearchIcon.Image = "rbxassetid://10734943674" -- Default search icon; replace with Lucide if available
                SearchIcon.ImageColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
                ...
                SearchInput.PlaceholderColor3 = (SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)):Lerp(Color3.new(0, 0, 0), 0.5)
                SearchInput.TextColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
            ...
            local function addTextLabel(text, isHeader, layoutOrder)
                ...
                TextLabel.Text = text
                TextLabel.TextColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
                ...
                if isHeader and (text == "[+] Added Features" or text == "[+] Updated Games" or text == "[-] Removed Features" or text == "[*] Improvements" or text == "[!] Known Issues" or text == "[?] Notes") then
                    TextLabel.BackgroundTransparency = 0
                    TextLabel.BackgroundColor3 = SelectedTheme.ElementBackgroundHover or Color3.fromRGB(60, 60, 60)
            ...
            for line in changelogText:gmatch("[^\r\n]+") do
                line = line:match("^%s*(.-)%s*$")
                local isHeader = line:match("^%w+$") or line:match("^What's New$") or line:match("^Improvements$") or line:match("^Bug Fixes$") or line:match("^Known Issues$") or line:match("^Notes$") or line:match("^Version:") or line:match("^Release Date:") or line:match("^%[%+%]") or line:match("^%[%-%]") or line:match("^%[%*%]") or line:match("^%[!%]") or line:match("^%[%?%]")
            ...
            CloseButton.TextColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
            ...
            AltButton.TextColor3 = SelectedTheme.TextColor or Color3.fromRGB(255, 255, 255)
            ...
            AltButton.MouseButton1Click:Connect(function()
                if setclipboard then
                    ...
                    if notificationsEnabled then -- New: Only show notification if enabled
                        RayfieldLibrary:Notify({
                            Title = altButtonNotification.Success.Title or (altButton.Name .. " Copied"),
                            Content = altButtonNotification.Success.Content or "The link has been copied to your clipboard!",
                            Duration = altButtonNotification.Success.Duration or 6.5,
                            Image = altButtonNotification.Success.Image or 10709798443
                        })
                    end
                else
                    if notificationsEnabled then -- New: Only show notification if enabled
                        RayfieldLibrary:Notify({
                            Title = altButtonNotification.Failure.Title or (altButton.Name .. " Failed"),
                            Content = altButtonNotification.Failure.Content or "Your executor doesn't support setclipboard.",
                            Duration = altButtonNotification.Failure.Duration or 6.5,
                            Image = altButtonNotification.Failure.Image or 10709799124
                        })
                    end
                end
            end)
            ...
            local function hideDialog()
                ...
                if notificationsEnabled then -- New: Only show notification if enabled
                    RayfieldLibrary:Notify({
                        Title = notification.Title or "Changelog Closed",
                        Content = notification.Content or "The changelog has been closed",
                        Duration = notification.Duration or 2.5,
                        Image = notification.Image or 10723346871
                    })
                end
            end
		...
		function Tab:CreateButton(ButtonSettings)
            ...
            if Button:FindFirstChild("UICorner") then
                Button.UICorner.CornerRadius = UDim.new(0, 2)
            end
            ...
            local ElementIndicator
            if Button:FindFirstChild("ElementIndicator") then
                ElementIndicator = Button.ElementIndicator
                if ElementIndicator:IsA("TextLabel") then
                    ElementIndicator:Destroy()
                    ElementIndicator = Instance.new("ImageLabel")
            ...
            ElementIndicator.Image = "rbxassetid://10723375250"
            ElementIndicator.ImageTransparency = 0.3
            ElementIndicator.ZIndex = 3
            ElementIndicator.ImageColor3 = Color3.fromRGB(200, 200, 200)

            for _, child in pairs(Button:GetChildren()) do
                if child:IsA("ImageLabel") and child.Name ~= "ElementIndicator" then
                    child.Visible = false
                end
            end
		...
		function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
            ...
            if ColorPicker:FindFirstChild("UICorner") then
		...
		function Tab:CreateLabel(LabelText : string, Icon: number, Color : Color3, IgnoreTheme : boolean)
            ...
            if Label:FindFirstChild("UICorner") then
				Label.UICorner.CornerRadius = UDim.new(0, 4)
			else
				local UICorner = Instance.new("UICorner")
				UICorner.CornerRadius = UDim.new(0, 4)
			...
			TweenService:Create(Label.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Exponential), {Transparency = Color and 0 or 0}):Play()
		...
		function Tab:CreateParagraph(ParagraphSettings)
            ...
            if Paragraph:FindFirstChild("UICorner") then
				Paragraph.UICorner.CornerRadius = UDim.new(0, 4)
			else
				local UICorner = Instance.new("UICorner")
				UICorner.CornerRadius = UDim.new(0, 4)
		...
		function Tab:CreateInput(InputSettings)
            ...
            local inputCorner = Input:FindFirstChildOfClass("UICorner")
			if inputCorner then
				inputCorner.CornerRadius = UDim.new(0, 4)
			else
				local newCorner = Instance.new("UICorner")
				newCorner.CornerRadius = UDim.new(0, 4)
				newCorner.Parent = Input
			end
		...
		function Tab:CreateDropdown(DropdownSettings)
            ...
            local corner = Dropdown:FindFirstChildOfClass("UICorner")
			if corner then
		...
		function Tab:CreateKeybind(KeybindSettings)
            ...
            local keybindCorner = Keybind:FindFirstChildOfClass("UICorner")
			if keybindCorner then
		...
		function Tab:CreateToggle(ToggleSettings)
            ...
            if not ToggleCorner then
                ToggleCorner = Instance.new("UICorner")
                ToggleCorner.Parent = Toggle
            end
            ToggleCorner.CornerRadius = UDim.new(0, 4)

            local SwitchCorner = Toggle.Switch:FindFirstChildOfClass("UICorner")
            if not SwitchCorner then
                SwitchCorner = Instance.new("UICorner")
                SwitchCorner.Parent = Toggle.Switch
            end
            SwitchCorner.CornerRadius = UDim.new(0, 8)

            local IndicatorCorner = Toggle.Switch.Indicator:FindFirstChildOfClass("UICorner")
            if not IndicatorCorner then
                IndicatorCorner = Instance.new("UICorner")
                IndicatorCorner.Parent = Toggle.Switch.Indicator
            end
		...
		function Tab:CreateSlider(SliderSettings)
            ...
            local SliderCorner = Slider:FindFirstChildOfClass("UICorner") or Instance.new("UICorner")
...
if Topbar:FindFirstChild('Settings') then
    Topbar.Settings.Image = "rbxassetid://10734950309"
    Topbar.Settings.ImageRectSize = Vector2.new(0, 0)
    Topbar.Settings.ImageRectOffset = Vector2.new(0, 0)
end

Topbar.ChangeSize.Image = "rbxassetid://10734895530"
Topbar.ChangeSize.ImageRectSize = Vector2.new(0, 0)
Topbar.ChangeSize.ImageRectOffset = Vector2.new(0, 0)
